...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DesignGroup'
        db.create_table(u'design_designgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'design', ['DesignGroup'])

        # Adding model 'Design'
        db.create_table(u'design_design', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('upload', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'design', ['Design'])

        # Adding model 'Pin'
        db.create_table(u'design_pin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ...
            ('msg', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'design', ['Pin'])


    def backwards(self, orm):
        # Deleting model 'DesignGroup'
        db.delete_table(u'design_designgroup')

        # Deleting model 'Design'
        db.delete_table(u'design_design')

        # Deleting model 'Pin'
        db.delete_table(u'design_pin')
